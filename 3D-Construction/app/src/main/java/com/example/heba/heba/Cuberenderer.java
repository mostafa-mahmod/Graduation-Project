...
//	float touchedY = 0;
    ...
    public Cuberenderer(Cubesurfaceview cubesurfaceview,float pos, Float X[],  Float Y[])
    {
        position=pos;
        x=X;
        y=Y;
        ...
        triangle1VerticesData = new float[]{
                // X, Y, Z,
...
//		// Position the eye behind the origin.
        ...
        if (mProgramHandle != 0)
        {
            ...
            mTextureDataHandle0 = loadTexture(mActivityContext, R.drawable.wall);
            mTextureDataHandle1 = loadTexture(mActivityContext, R.drawable.wind);
            mTextureDataHandle2 = loadTexture(mActivityContext, R.drawable.nature1);
...
//effects of projection matrix. if you want you can uncomment this line
    ...
    public void onDrawFrame(GL10 glUnused)
    {
        ...
        for (int i = 1; i <x.length ; i++) {
            ...
            Matrix.scaleM(mModelMatrix, 0, 2.2f, 2.2f, 2.2f);
//	        Matrix.rotateM(mModelMatrix, 0, angleInDegrees, 1.0f, 1.0f, 1.0f);
            ...
            dx /= dist;
            dy /= dist;
            float x3 = x1 + thickness*dy;
            float y3 = y1 - thickness*dx;
            float x4 = x2 + thickness*dy;
            float y4 = y2 - thickness*dx;
            ...
            triangle1VerticesData = new float[]{
                    ...
                    //Back
                    x2, y2, 0+height,   //fo2 yemen
                    x1, y1, 0+height,   //fo2 shmal
                    x3, y3, 0+height,   //origin  t7t shmal
                    x4, y4, 0+height,   //t7t yemen
            ...
            Matrix.rotateM(mModelMatrix, 0, -yAngle, 1.0f, 0.0f, 0.0f);
//	        Matrix.rotateM(mModelMatrix, 0, angleInDegrees, 1.0f, 1.0f, 1.0f);
//                Matrix.translateM(mModelMatrix, 0,heba,0, 0);
            //          Matrix.scaleM(mModelMatrix, 0, 2.2f, 2.2f, 2.2f);
